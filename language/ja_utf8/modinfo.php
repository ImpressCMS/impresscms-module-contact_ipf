...
define("_MI_CONTACT_PRIMARY_CONTACT", "プライマリ連絡先メールアドレス（複数可）");
define("_MI_CONTACT_PRIMARY_CONTACT_DSC", "ユーザ側から送信されたメッセージは、これらのアドレスに送られる。 カンマ文字 ',' で複数のアドレスを区切る。");
define("_MI_CONTACT_MESSAGE_ADD", "メッセージを送信");
define("_MI_CONTACT_MESSAGE_ADD_DSC", "サイト管理者にメールを送信するには、このフォームを提出してください。");
